      ...
      >
        <div className="card clt-card">
          <div className="clt-header">
            <div>
              <h6 className="clt-title">My Finalists</h6>
              <p className="clt-subtitle">
                Finalists assigned to you for Executive Jury scoring · {submittedCount}/{nominees.length} scored
              </p>
            </div>
              ...
              <table className="table table-hover align-middle mb-0">
                <thead>
                  <tr className="clt-thead-row">
                    <th className="clt-th ps-4">Finalist</th>
